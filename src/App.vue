  ...
  <div id="app">
    ...
    <section class="main-content">
      <div class="section-title">
        <h2>Analize en segundos la gramatica y ortografia de su documento PDF.</h2>
      </div>
      ...
      <div class="how-to-use">
        ...
        <div class="step-cards">
          <div class="step-card">Paso 1: Elija el PDF que desea analizar desde su ordenador.</div>
          <div class="step-card">Paso 2: Nuestro analizador de ortografia y gramatica comenzará a extraer el texto de su
            PDF.</div>
          <div class="step-card">Paso 3: En segundos se crea un documento PDF donde se resaltan los errores gramaticales y
            ortograficos y listo para descargar.</div>
        </div>
      </div>
    </section>
  </div>
